...
from CrushRobot import TIGERS, WOLVES, dispatcher
from CrushRobot.modules.disable import DisableAbleCommandHandler
from CrushRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from CrushRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from CrushRobot.modules.helper_funcs.string_handling import split_quotes
from CrushRobot.modules.log_channel import loggable
from CrushRobot.modules.sql import warns_sql as sql
