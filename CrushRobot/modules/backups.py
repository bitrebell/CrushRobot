...
# from CrushRobot.modules.sql import warns_sql as warnssql
import CrushRobot.modules.sql.blacklist_sql as blacklistsql

# from CrushRobot.modules.sql import cust_filters_sql as filtersql
# import CrushRobot.modules.sql.welcome_sql as welcsql
import CrushRobot.modules.sql.locks_sql as locksql
import CrushRobot.modules.sql.notes_sql as sql

# from CrushRobot.modules.rules import get_rules
import CrushRobot.modules.sql.rules_sql as rulessql
from CrushRobot import JOIN_LOGGER, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from CrushRobot.__main__ import DATA_IMPORT
from CrushRobot.modules.connection import connected
from CrushRobot.modules.helper_funcs.alternate import typing_action
from CrushRobot.modules.helper_funcs.chat_status import user_admin
from CrushRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("CrushRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("CrushRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `CrushRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("CrushRobot{}.backup".format(chat_id))  # Cleaning file
