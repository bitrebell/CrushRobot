...
from CrushRobot import dispatcher, telethn
from CrushRobot.__main__ import (
    CHAT_SETTINGS,
    DATA_EXPORT,
    DATA_IMPORT,
    HELPABLE,
...
from CrushRobot.modules.helper_funcs.chat_status import dev_plus, sudo_plus
...
def load(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module("CrushRobot.modules." + text)
    except:
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("CrushRobot.modules.", 1)[1]
